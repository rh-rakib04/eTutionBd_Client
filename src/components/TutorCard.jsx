  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition">
        <div className="absolute -inset-1 bg-linear-to-r from-primary to-secondary blur-xl opacity-20"></div>
      </div>

      {/* Tutor Info */}
      <div className="relative z-10 flex gap-4 items-center">
        {/* Avatar */}
        <div className="p-0.5 rounded-full bg-linear-to-r from-primary to-secondary">
          <img
            src={tutor.photoURL}
